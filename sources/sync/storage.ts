...
interface StorageState {
    ...
    updateSessionModelMode: (sessionId: string, mode: import('@/components/PermissionModeSelector').ModelMode) => void;
    // Artifact methods
...
export const storage = create<StorageState>()((set, get) => {
    ...
    return {
        ...
        updateSessionModelMode: (sessionId: string, mode: import('@/components/PermissionModeSelector').ModelMode) => set((state) => {
            const session = state.sessions[sessionId];
            if (!session) return state;
